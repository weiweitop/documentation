...
function addBackToTop() {
    ...
    ! function() {
        ...
        i.appendChild(document.createTextNode(n)), document.head.insertAdjacentElement("afterbegin", i)
    }();
    var T = function() {
            var o = document.createElement("div");
            return o.id = e, o.className = "hidden", o.innerHTML = l, o.addEventListener("click", function(o) {
                o.preventDefault(),
                    function() {
                        var o = window,
                            t = o.performance,
    ...
    function C(o) {
        document.body.scrollTop = o, document.documentElement && (document.documentElement.scrollTop = o)
    }
}